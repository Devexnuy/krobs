                ...
                *************** Next post if exist ***************
                ...
                if (!empty( $next_post )): ?>
                    ...
                    if($loop->have_posts()) : while( $loop->have_posts() ): $loop->the_post();?>
                        ...
                        <?php $next_post_one = get_next_post(true);
                        if (!empty($next_post_one)): ?>
                            <?php $args['p'] = $next_post_one->ID;
                            $loop_one = new WP_Query( $args );
                            if($loop_one->have_posts()) : while($loop_one->have_posts() ): $loop_one->the_post();?>
                                <div class="swiper-slide">
                                    <div <?php post_class('krobs-post');?>>
                                        <div class="post-media">
                                            <?php if($gallery = get_post_gallery( get_the_ID(), false )){
                                ...
                                <?php $next_post_two = get_next_post(true);
                                if (!empty($next_post_two)): ?>
                                    <?php $args['p'] = $next_post_two->ID;
                                    $loop_two = new WP_Query( $args );
                                    if($loop_two->have_posts()) : while($loop_two->have_posts() ): $loop_two->the_post();?>
                                        <div class="swiper-slide">
                                            <div <?php post_class('krobs-post');?>>
                                                <div class="post-media">
                                                    <?php if($gallery = get_post_gallery( get_the_ID(), false )){
