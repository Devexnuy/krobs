...
function initKrobs() {
    ...
    var a = new Swiper(".swiper-container", {
        ...
        onSlideChangeStart: function(b) {
            ...
            jQuery("nav  a").eq(a.activeIndex).addClass("active");
    ...
    jQuery("nav  a.swp").on("touchstart mousedown", function(b) {
        b.preventDefault();
        jQuery("nav .active").removeClass("active");
        jQuery(this).addClass("active");
        a.swipeTo(jQuery(this).index());
    });
    jQuery("nav  a.swp").click(function(a) {
        a.preventDefault();
    });
...
// scroll nav   ----------------------------------------
    jQuery(".scroll-nav a").bind("click", function(a) {
        a.preventDefault();
        jQuery(".container").scrollTo(jQuery(this).attr("href"), 950, {
            easing: "swing",
            offset: -140,
            axis: "y"
        });
...
jQuery(window).load(function() {
    !function() {
        ...
        jQuery(".open-project-link").click(function() {
            jQuery(".container").scrollTo("#options", 600, {
                axis: "y"
            });
